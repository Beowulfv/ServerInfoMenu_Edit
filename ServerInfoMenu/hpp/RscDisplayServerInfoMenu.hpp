...
{
   idd = 159753;
   onLoad = "uiNamespace setVariable ['RscDisplayServerInfoMenu', _this select 0]; [] ExecVM 'custom\ServerInfoMenu\sqf\onLoad.sqf'; playSound ['ZoomIn', true]; 'DynamicBlur' ppEffectEnable true; 'DynamicBlur' ppEffectAdjust [7]; 'DynamicBlur' ppEffectCommit 0.1";
   ...
   class Controls
   {
      ...
      class menu:RscListbox
      {
         ...
         idc = 7;
         onLBSelChanged = "[] ExecVM 'custom\ServerInfoMenu\sqf\handleContent.sqf'";
      };
